...
namespace MetroFramework
{
    public partial class MetroMessageBoxControl : Form
    {
        ...
        private const string OkText = "确定(&O)";
        private const string CancelText = "取消(&C)";
        private const string YesText = "是(&Y)";
        private const string NoText = "否(&N)";
        private const string AbortText = "终止(&A)";
        private const string RetryText = "重试(&R)";
        private const string IgnoreText = "忽略(&I)";
        ...
        public void ArrangeApperance()
        {
            ...
            switch (_properties.Buttons)
            {
                ...
                case MessageBoxButtons.YesNo:
                    ...
                    metroButton1.Text = YesText;
                    metroButton1.Location = metroButton2.Location;
                    metroButton1.Tag = DialogResult.Yes;

                    EnableButton(metroButton2);

                    metroButton2.Text = NoText;
                    metroButton2.Location = metroButton3.Location;
                ...
                case MessageBoxButtons.AbortRetryIgnore:
                    ...
                    metroButton1.Text = AbortText;
                    metroButton1.Tag = DialogResult.Abort;

                    EnableButton(metroButton2);

                    metroButton2.Text = RetryText;
                    metroButton2.Tag = DialogResult.Retry;

                    EnableButton(metroButton3);

                    metroButton3.Text = IgnoreText;
